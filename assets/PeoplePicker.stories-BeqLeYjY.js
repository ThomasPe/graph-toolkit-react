import{a as e,n as t}from"./chunk-BneVvdWh.js";import{C as n,S as r,a as i,b as a,c as o,d as s,i as c,l,n as u,o as d,ot as f,r as p,s as ee,t as m,u as te,v as h,x as g,y as ne}from"./iframe-B_Hr2g1Q.js";import{f as _,g as v,h as re,i as y,l as b,n as x,o as S,p as C,r as w,s as ie,t as T,u as ae}from"./MockProvider-9UjmAtpQ.js";import{n as E,t as D}from"./usePersonData-I-pxTSJs.js";var O,k,A,oe,j=t((()=>{O=e(f()),S(),C(),w(),k=`id,displayName,mail,userPrincipalName,jobTitle,department`,A=e=>e.trim().replace(/"/g,``).trim(),oe=(e,t)=>{let n=ie(),r=re(),i=v(),a=t?.minChars??1,o=t?.maxResults??10,s=t?.loadInitialResults??!1,[c,l]=(0,O.useState)([]),[u,d]=(0,O.useState)(!1);return(0,O.useEffect)(()=>{let t=A(e),c=s&&e.length===0;if(!c&&(!t||t.length<a)){l([]),d(!1);return}let u=!1,f=async()=>{d(!0);try{if(y(r)){let e=await r.searchPeople(c?``:t,o);u||l(e)}else if(i===`SignedIn`&&n){let e;e=c?(await n.api(`/users`).select(k).top(o).get()).value??[]:(await n.api(`/users`).header(`ConsistencyLevel`,`eventual`).search(`"displayName:${t}" OR "mail:${t}" OR "userPrincipalName:${t}"`).select(k).top(o).get()).value??[],u||l(e)}else u||l([])}catch{u||l([])}finally{u||d(!1)}};if(c)return f(),()=>{u=!0};let p=setTimeout(()=>{f()},300);return()=>{u=!0,clearTimeout(p)}},[e,n,r,i,a,o,s]),{results:c,loading:u}}})),M,N,P,se,F,I,L,R,z,B,ce=t((()=>{M=e(f()),m(),ne(),j(),D(),ae(),N=e(n()),P=`__no_results__`,se=50,F=e=>e.displayName||e.mail||e.userPrincipalName||e.id,I=e=>e.mail??e.userPrincipalName??void 0,L=({person:e,size:t,photoUrl:n})=>(0,N.jsx)(h,{name:e.displayName??void 0,image:n?{src:n}:void 0,initials:n?void 0:b(e.displayName??void 0),size:t}),R=({person:e,size:t})=>{let{photoUrl:n}=E({userId:e.id,fetchPhoto:!0});return(0,N.jsx)(L,{person:e,size:t,photoUrl:n})},z=({person:e,size:t})=>e.photoUrl?(0,N.jsx)(L,{person:e,size:t,photoUrl:e.photoUrl}):(0,N.jsx)(R,{person:e,size:t}),B=({selectedPeople:e,defaultSelectedPeople:t,onSelectionChange:n,placeholder:r=`Search for people...`,maxPeople:s,searchMinChars:f=1,maxSearchResults:m=10,excludeUserIds:h=[],appearance:g,size:ne,disabled:_})=>{let v=e!==void 0,[re,y]=(0,M.useState)(t??[]),b=v?e:re,[x,S]=(0,M.useState)(``),[C,w]=(0,M.useState)(!1),ie=(0,M.useMemo)(()=>Array.from(new Set(h)),[h]),{results:T,loading:ae}=oe(x,{minChars:f,maxResults:Math.min(m+ie.length,se),loadInitialResults:C}),E=(0,M.useMemo)(()=>{let e=new Map;for(let t of b)e.set(t.id,t);for(let t of T)e.set(t.id,t);return e},[b,T]),D=(0,M.useMemo)(()=>b.map(e=>e.id),[b]),O=(0,M.useCallback)((e,t)=>{let r=t.selectedOptions.filter(e=>e!==P).map(e=>E.get(e)).filter(e=>e!==void 0);v||y(r),n?.(r),S(``)},[v,n,E]),k=(0,M.useCallback)(e=>{S(e.target.value)},[]),A=(0,M.useCallback)(()=>{w(!0)},[]),j=(0,M.useCallback)(()=>{w(!1)},[]),L=s!==void 0&&b.length>=s,R=(0,M.useMemo)(()=>T.filter(e=>!D.includes(e.id)&&!h.includes(e.id)).slice(0,m),[T,D,h,m]);return(0,N.jsxs)(ee,{onOptionSelect:O,selectedOptions:D,appearance:g,size:ne,disabled:_,children:[(0,N.jsxs)(c,{expandIcon:(0,N.jsx)(a,{}),children:[(0,N.jsx)(u,{children:b.map(e=>(0,N.jsxs)(te,{value:e.id,shape:`rounded`,children:[(0,N.jsx)(l,{hasSecondaryAction:!0,media:(0,N.jsx)(z,{person:e,size:16}),children:F(e)}),(0,N.jsx)(o,{"aria-label":`Remove ${F(e)}`})]},e.id))}),!L&&(0,N.jsx)(d,{value:x,onChange:k,onFocus:A,onBlur:j,placeholder:b.length===0?r:void 0,disabled:_})]}),(0,N.jsxs)(i,{children:[x.length>=f&&!ae&&R.length===0&&(0,N.jsx)(p,{value:P,text:`No people found`,style:{pointerEvents:`none`,color:`var(--colorNeutralForegroundDisabled)`},children:`No people found`}),R.map(e=>(0,N.jsx)(p,{value:e.id,media:(0,N.jsx)(z,{person:e,size:32}),secondaryContent:I(e),children:F(e)},e.id))]})]})},B.__docgenInfo={description:`PeoplePicker — a tag-picker backed by Microsoft Graph people search.
