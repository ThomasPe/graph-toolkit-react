import{a as e,n as t}from"./chunk-BneVvdWh.js";import{C as n,E as r,g as i,lt as a,m as o,p as s,t as c,v as l,w as u,y as d}from"./iframe-DfxnQ5yA.js";import{f,n as p,p as m,t as h}from"./MockProvider-CkZe5JRe.js";import{n as g,t as _}from"./usePeopleList-CtsTB-kd.js";var v,y,b,x,S,C,w,T,E=t((()=>{v=e(a()),c(),_(),y=e(r()),b=3,x=10,S=e=>{switch(e?.toLowerCase()){case`available`:case`availableidle`:return`available`;case`away`:case`berightback`:return`away`;case`busy`:case`busyidle`:case`donotdisturb`:return`busy`;case`offline`:case`presenceunknown`:return`offline`;default:return}},C=e=>e.displayName??e.mail??e.userPrincipalName??e.id,w=e=>{let t=C(e),n=S(e.presenceAvailability);return(0,y.jsx)(l,{name:t,avatar:{name:t,image:e.photoUrl?{src:e.photoUrl}:void 0,badge:n?{status:n}:void 0,color:`colorful`}},e.id)},T=({people:e,userIds:t,selectFields:n,sortBy:r,sortDirection:a,groupId:s,showMax:c=b,showPresence:l=!1,layout:u=`stack`,size:f=32,onUpdated:p,...m})=>{let{people:h,loading:_,error:S}=g({people:e,userIds:t,selectFields:n,sortBy:r,sortDirection:a,groupId:s,maxPeople:Math.max(x,c+5),showPresence:l});if((0,v.useEffect)(()=>{if(!p||_)return;let t=`peopleLoaded`;S?t=`peopleLoadFailed`:e&&(t=`peopleChanged`),p({trigger:t,people:h,loading:!1,error:S})},[S,_,p,e,h]),_)return(0,y.jsx)(o,{size:`tiny`});if(h.length===0)return null;let C=Math.max(0,c),T=h.slice(0,C),E=h.slice(C);return(0,y.jsxs)(d,{layout:u,size:f,...m,children:[T.map(w),E.length>0&&(0,y.jsx)(i,{count:E.length,children:E.map(w)})]})},T.__docgenInfo={description:"`People` renders a compact avatar strip similar to the MGT `mgt-people` control.\n\nThe component can render a supplied list of people, resolve a list of `userIds`, load\ngroup members, or default to tenant directory users from `/users`.\n\n@param props - Avatar group configuration and people-loading options\n@returns A compact avatar group, a loading spinner, or `null` when no people are available",methods:[],displayName:`People`,props:{people:{required:!1,tsType:{name:`Array`,elements:[{name:`intersection`,raw:`PersonDetails & PeopleSearchResult`,elements:[{name:`PersonDetails`},{name:`PeopleSearchResult`}]}],raw:`PeoplePerson[]`},description:`A pre-resolved list of people to render.
