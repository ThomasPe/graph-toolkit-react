import{a as e,n as t}from"./chunk-BneVvdWh.js";import{C as n,E as r,S as i,T as a,a as o,b as s,c,d as l,f as u,h as d,i as f,l as ee,lt as p,m,n as te,o as ne,p as h,r as re,s as ie,t as g,u as ae,w as _,x as oe}from"./iframe-DVxoCyK9.js";import{f as v,g as y,h as b,i as se,l as x,n as S,o as C,p as w,r as T,s as E,t as D,u as ce}from"./MockProvider-aaEsUZLW.js";import{n as le,t as ue}from"./usePeopleList-C7MARh75.js";import{n as de,t as fe}from"./usePersonData-DBImgGDW.js";var O,k,pe,me,he=t((()=>{O=e(p()),C(),w(),T(),k=`id,displayName,mail,userPrincipalName,jobTitle,department`,pe=e=>e.trim().replace(/"/g,``).trim(),me=(e,t)=>{let n=E(),r=b(),i=y(),a=t?.minChars??1,o=t?.maxResults??10,s=t?.loadInitialResults??!1,[c,l]=(0,O.useState)([]),[u,d]=(0,O.useState)(!1);return(0,O.useEffect)(()=>{let t=pe(e),c=s&&e.length===0;if(!c&&(!t||t.length<a)){l([]),d(!1);return}let u=!1,f=async()=>{d(!0);try{if(se(r)){let e=await r.searchPeople(c?``:t,o);u||l(e)}else if(i===`SignedIn`&&n){let e;e=c?(await n.api(`/users`).select(k).top(o).get()).value??[]:(await n.api(`/users`).header(`ConsistencyLevel`,`eventual`).search(`"displayName:${t}" OR "mail:${t}" OR "userPrincipalName:${t}"`).select(k).top(o).get()).value??[],u||l(e)}else u||l([])}catch{u||l([])}finally{u||d(!1)}};if(c)return f(),()=>{u=!0};let ee=setTimeout(()=>{f()},300);return()=>{u=!0,clearTimeout(ee)}},[e,n,r,i,a,o,s]),{results:c,loading:u}}})),A,j,M,ge,N,P,_e,F,ve,I,L,ye=t((()=>{A=e(p()),g(),oe(),he(),fe(),ce(),j=e(r()),M=`__no_results__`,ge=50,N=(e,t,n,r)=>e.filter(e=>!t.includes(e.id)&&!n.includes(e.id)).slice(0,r),P=e=>e.displayName||e.mail||e.userPrincipalName||e.id,_e=e=>e.mail??e.userPrincipalName??void 0,F=({person:e,size:t,photoUrl:n})=>(0,j.jsx)(s,{name:e.displayName??void 0,image:n?{src:n}:void 0,initials:n?void 0:x(e.displayName??void 0),size:t}),ve=({person:e,size:t})=>{let{photoUrl:n}=de({userId:e.id,fetchPhoto:!0});return(0,j.jsx)(F,{person:e,size:t,photoUrl:n})},I=({person:e,size:t})=>e.photoUrl?(0,j.jsx)(F,{person:e,size:t,photoUrl:e.photoUrl}):(0,j.jsx)(ve,{person:e,size:t}),L=({selectedPeople:e,defaultSelectedPeople:t,onSelectionChange:n,placeholder:r=`Search for people...`,maxPeople:a,searchMinChars:s=1,maxSearchResults:l=10,excludeUserIds:u=[],appearance:d,size:p,disabled:m,onUpdated:h})=>{let g=e!==void 0,[_,oe]=(0,A.useState)(t??[]),v=g?e:_,[y,b]=(0,A.useState)(``),[se,x]=(0,A.useState)(!1),S=(0,A.useMemo)(()=>Array.from(new Set(u)),[u]),{results:C,loading:w}=me(y,{minChars:s,maxResults:Math.min(l+S.length,ge),loadInitialResults:se}),T=(0,A.useMemo)(()=>{let e=new Map;for(let t of v)e.set(t.id,t);for(let t of C)e.set(t.id,t);return e},[v,C]),E=(0,A.useMemo)(()=>v.map(e=>e.id),[v]),D=(0,A.useMemo)(()=>N(C,E,S,l),[C,E,S,l]),ce=(0,A.useCallback)((e,t)=>{let r=t.selectedOptions.filter(e=>e!==M).map(e=>T.get(e)).filter(e=>e!==void 0),i=N(C,r.map(e=>e.id),S,l);g||oe(r),n?.(r),h?.({trigger:`selectionChanged`,searchQuery:``,selectedPeople:r,searchResults:i,loading:w}),b(``)},[g,l,n,h,T,w,C,S]),le=(0,A.useCallback)(e=>{b(e.target.value)},[]),ue=(0,A.useCallback)(()=>{x(!0)},[]),de=(0,A.useCallback)(()=>{x(!1)},[]),fe=a!==void 0&&v.length>=a,O=(0,A.useRef)(!0);return(0,A.useEffect)(()=>{if(!h||w)return;let e=O.current&&y.length===0&&D.length===0;O.current=!1,!e&&h({trigger:`searchResultsUpdated`,searchQuery:y,selectedPeople:v,searchResults:D,loading:!1})},[v,D,h,w,y]),(0,j.jsxs)(ie,{onOptionSelect:ce,selectedOptions:E,appearance:d,size:p,disabled:m,children:[(0,j.jsxs)(f,{expandIcon:(0,j.jsx)(i,{}),children:[(0,j.jsx)(te,{children:v.map(e=>(0,j.jsxs)(ae,{value:e.id,shape:`rounded`,children:[(0,j.jsx)(ee,{hasSecondaryAction:!0,media:(0,j.jsx)(I,{person:e,size:16}),children:P(e)}),(0,j.jsx)(c,{"aria-label":`Remove ${P(e)}`})]},e.id))}),!fe&&(0,j.jsx)(ne,{value:y,onChange:le,onFocus:ue,onBlur:de,placeholder:v.length===0?r:void 0,disabled:m})]}),(0,j.jsxs)(o,{children:[y.length>=s&&!w&&D.length===0&&(0,j.jsx)(re,{value:M,text:`No people found`,style:{pointerEvents:`none`,color:`var(--colorNeutralForegroundDisabled)`},children:`No people found`}),D.map(e=>(0,j.jsx)(re,{value:e.id,media:(0,j.jsx)(I,{person:e,size:32}),secondaryContent:_e(e),children:P(e)},e.id))]})]})},L.__docgenInfo={description:`PeoplePicker — a tag-picker backed by Microsoft Graph people search.
...
@param event - Details about the update trigger and the picker state after the update.`}},composes:[`Pick`]}})),be=t((()=>{ye()})),R,z,B,V,H,xe,Se,U,W,G,K,q,J,Y,X,Z,Q,$,Ce;t((()=>{R=e(p()),g(),be(),w(),S(),ue(),z=e(r()),{fn:B}=__STORYBOOK_MODULE_TEST__,V=new D({autoSignIn:!0}),H=e=>e.displayName??e.mail??e.userPrincipalName??e.id,xe=e=>{let[t,n]=(0,R.useState)([]),r=(0,R.useMemo)(()=>t.map(e=>e.id),[t]),{people:i,loading:o}=le((0,R.useMemo)(()=>r.length>0?{userIds:r,sortBy:`surname`,selectFields:[`givenName`,`surname`]}:{people:[],sortBy:`surname`,selectFields:[`givenName`,`surname`]},[r])),s=t=>{n(t),e.onSelectionChange?.(t)};return(0,z.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:16},children:[(0,z.jsx)(L,{...e,selectedPeople:t,onSelectionChange:s}),(0,z.jsxs)(l,{style:{display:`flex`,flexDirection:`column`,gap:8,padding:16,backgroundColor:a.colorNeutralBackground2},children:[(0,z.jsx)(h,{weight:`semibold`,children:`Stored object IDs`}),(0,z.jsx)(u,{children:`This mirrors the common app pattern where the picker drives selection, but persistence only stores Microsoft Entra object IDs.`}),(0,z.jsx)(`code`,{style:{whiteSpace:`pre-wrap`},children:r.length>0?JSON.stringify(r,null,2):`[]`})]}),(0,z.jsxs)(l,{style:{display:`flex`,flexDirection:`column`,gap:12,padding:16},children:[(0,z.jsx)(h,{weight:`semibold`,children:`Selected users sorted by surname`}),(0,z.jsxs)(u,{children:[`The list is resolved with `,(0,z.jsx)(`code`,{children:`usePeopleList`}),` using the stored IDs, then sorted by`,(0,z.jsx)(`code`,{children:`surname`}),`.`]}),r.length===0?(0,z.jsx)(h,{children:`Select a few people to populate the list.`}):o?(0,z.jsx)(m,{label:`Resolving selected users...`,size:`tiny`}):(0,z.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:i.map(e=>(0,z.jsx)(d,{name:H(e),primaryText:H(e),secondaryText:e.jobTitle??e.mail??void 0,tertiaryText:e.department??void 0,avatar:{image:e.photoUrl?{src:e.photoUrl}:void 0,name:H(e)}},e.id))})]})]})},Se={title:`Components/PeoplePicker`,component:L,tags:[`autodocs`],parameters:{layout:`padded`,docs:{description:{component:"Search and select one or more people from Microsoft Graph using the Fluent UI TagPicker.\n\nThe `PeoplePicker` supports both **controlled** and **uncontrolled** usage patterns.\n\nSee the **Selected Users List** story for the recommended consumer pattern when your app stores\nonly object IDs from picker selections and later resolves a sorted list with `usePeopleList`.\n\nWhen wrapping with a `MockProvider` (with `autoSignIn: true`), it uses built-in mock data so you can prototype without any auth configuration."}}},decorators:[e=>(0,z.jsx)(n,{theme:_,children:(0,z.jsx)(v,{provider:V,children:(0,z.jsx)(`div`,{style:{width:400},children:(0,z.jsx)(e,{})})})})],args:{onSelectionChange:B(),onUpdated:B()},argTypes:{placeholder:{control:`text`},maxPeople:{control:{type:`number`,min:1}},searchMinChars:{control:{type:`number`,min:1}},maxSearchResults:{control:{type:`number`,min:1}},appearance:{control:`select`,options:[`outline`,`underline`,`filled-darker`,`filled-lighter`]},size:{control:`select`,options:[`small`,`medium`,`large`]},disabled:{control:`boolean`}}},U={args:{placeholder:`Search for people...`}},W={name:`With Default Selected`,args:{placeholder:`Search for people...`,defaultSelectedPeople:[{id:`00000000-0000-0000-0000-000000000001`,displayName:`Adele Vance`,mail:`adelev@contoso.com`,userPrincipalName:`adelev@contoso.com`,jobTitle:`Product Manager`}]}},G={name:`Controlled`,render:e=>{let[t,n]=(0,R.useState)([{id:`00000000-0000-0000-0000-000000000010`,displayName:`Megan Bowen`,mail:`meganb@contoso.com`,userPrincipalName:`meganb@contoso.com`,jobTitle:`Marketing Manager`}]),r=t=>{n(t),e.onSelectionChange?.(t)};return(0,z.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:12},children:[(0,z.jsx)(L,{...e,selectedPeople:t,onSelectionChange:r}),(0,z.jsxs)(h,{size:200,children:[`Selected: `,t.map(e=>e.displayName).join(`, `)||`(none)`]})]})},args:{placeholder:`Search for people...`}},K={name:`Selected Users List`,render:e=>(0,z.jsx)(xe,{...e}),args:{placeholder:`Search and add people...`,maxPeople:5}},q={name:`Max 3 People`,args:{placeholder:`Search for up to 3 people...`,maxPeople:3}},J={name:`Min 2 Characters`,args:{placeholder:`Type 2+ characters to search...`,searchMinChars:2}},Y={name:`Size: Small`,args:{placeholder:`Search...`,size:`small`}},X={name:`Size: Large`,args:{placeholder:`Search...`,size:`large`}},Z={args:{placeholder:`Search for people...`,disabled:!0,defaultSelectedPeople:[{id:`00000000-0000-0000-0000-000000000001`,displayName:`Adele Vance`,mail:`adelev@contoso.com`}]}},Q={name:`Appearance: Underline`,args:{placeholder:`Search for people...`,appearance:`underline`}},$={name:`Appearance: Filled Darker`,args:{placeholder:`Search for people...`,appearance:`filled-darker`},decorators:[e=>(0,z.jsx)(n,{theme:_,children:(0,z.jsx)(v,{provider:V,children:(0,z.jsx)(`div`,{style:{width:400,padding:16,background:`var(--colorNeutralBackground1)`},children:(0,z.jsx)(e,{})})})})]},U.parameters={...U.parameters,docs:{...U.parameters?.docs,source:{originalSource:`{
  args: {
    placeholder: 'Search for people...'
  }
