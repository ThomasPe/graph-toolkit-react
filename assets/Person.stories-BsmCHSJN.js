import{a as e,n as t}from"./chunk-DnJy8xQt.js";import{L as n,xt as r}from"./iframe-B9NkfySm.js";import{f as i,n as a,p as o,t as s}from"./MockProvider-BsblHSd3.js";import{n as c,t as l}from"./Person-5lj1wO2O.js";var u,d,f,p,m,h,g,_,v,y,b,x,S,C,w,T,E,D;t((()=>{r(),l(),o(),a(),u=e(n()),{fn:d}=__STORYBOOK_MODULE_TEST__,f={title:`Components/Person`,component:c,parameters:{layout:`centered`,docs:{description:{component:`Display a person with avatar, text lines, and presence by composing Fluent UI Persona with Microsoft Graph data.
...
}`,...E.parameters?.docs?.source}}},D=[`Default`,`AvatarOnly`,`Lines`,`Size`,`TextAlignment`,`TextPosition`,`Presence`,`GraphDirectData`,`GraphLineProperties`,`GraphRenderedLines`,`GraphImageFallback`,`GraphLoadingState`,`GraphPersonCardHover`,`GraphPersonCardClick`]}))();export{m as AvatarOnly,p as Default,b as GraphDirectData,C as GraphImageFallback,x as GraphLineProperties,w as GraphLoadingState,E as GraphPersonCardClick,T as GraphPersonCardHover,S as GraphRenderedLines,h as Lines,y as Presence,g as Size,_ as TextAlignment,v as TextPosition,D as __namedExportsOrder,f as default};